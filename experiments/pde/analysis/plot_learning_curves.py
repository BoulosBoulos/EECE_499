...
from experiments.pde.analysis.compute_aulc import CANONICAL_METHODS, extract_method_name
...
def load_training_csvs(results_dir, scenario, maneuver):
    ...
    for csv_path in csv_files:
        try:
            ...
            method = extract_method_name(stem)
            if method == "unknown" or method not in METHOD_LABELS:
