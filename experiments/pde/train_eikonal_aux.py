...
def main():
    ...
    policy = EikonalAuxAgent(
        ...
        lambda_eik=args.lambda_aux if args.lambda_aux is not None else float(pde_cfg.get("lambda_eik", 0.2)),
    ...
    meta = {
        ...
        "lambda_eik_effective": args.lambda_aux if args.lambda_aux is not None else float(pde_cfg.get("lambda_eik", 0.2)),
