...
class SoftHJBAuxAgent:
    ...
    def train_step(
        ...
        if extra is not None and "xi_curr" in extra:
            ...
            # pde_q_values needs autograd internally to compute grad_U (see
            # residuals._compute_grad_U). We detach the *outputs* so the
            # downstream actor-align KL doesn't backprop into the aux critic.
    ...
    @classmethod
    def from_checkpoint(cls, path: str, device: str = "cpu", **overrides) -> "SoftHJBAuxAgent":
